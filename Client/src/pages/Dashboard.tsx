  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-lg">
        <h2 className="text-2xl text-slate-900">Welcome to the Dashboard</h2>
        <p className="text-slate-500 text-sm mt-0.5">
          This is your main dashboard where you can manage all your social media
          activities.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {statCards.map((card) => (
          <div
            key={card.label}
            className="p-5 bg-white hover:bg-blue-50 relative border border-slate-200 rounded-2xl hover:border-blue-200 transition-all"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="tabular-nums text-slate-800 font-medium text-3xl">
                {card.value}
              </div>
              <div className="absolute right-4 top-4 text-blue-500 flex items-center gap-1 text-xs">
